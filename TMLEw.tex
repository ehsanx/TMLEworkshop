...
\includegraphics{TMLEw_files/figure-latex/unnamed-chunk-7-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit.sl2 }\OtherTok{\textless{}{-}} \FunctionTok{recombineSL}\NormalTok{(fit.sl, }\AttributeTok{Y =}\NormalTok{ Y, }\AttributeTok{method =} \StringTok{"method.CC\_LS"}\NormalTok{)}
\NormalTok{fit.sl2}\SpecialCharTok{$}\NormalTok{coef}
\end{Highlighting}
\end{Shaded}
...
We construct our outcome model, and make our initial predictions. For this step, we will use \textbf{SuperLearner}. This requires no apriori assumptions about the structure of our outcome model.
